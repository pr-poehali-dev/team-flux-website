...
const history = [
  { year: "2026", event: "Основание Team Flux. Собрался полный состав из 5 игроков." },
  { year: "2026", event: "Первый турнир. Команда выходит на соревновательную сцену." },
];
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          ...
          <p className="text-gray-400 text-lg max-w-2xl leading-relaxed">
            ...
            Основаны в 2026 году — молодая и голодная до побед команда, которая уже заявляет о себе на турнирной сцене.
          </p>
        </div>
      </section>
